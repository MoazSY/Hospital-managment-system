...
return [
    ...
    */
    ...
    'providers' => [
        ...
        'hospital_manager'=>[
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Models\Hospital_manager::class),
        ],
        'accounter'=>[
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Models\Accounter::class),
        ],
        'consumer_employee'=>[
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Models\Consumer_employee::class),
        ],
        'doctor'=>[
            'driver' => 'eloquent',
        ...
        'warehouse_manager'=>[
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Models\Warehouse_manager::class),
        ],
        'reseption_employee'=>[
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Models\Reseption_employee::class),
        ],
